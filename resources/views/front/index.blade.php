                ...
                <div class="contact__right-item">
                    ...
                    <div class="contact__form">
                        ...
                        <div class="alert alert-success">
                            {{ session('success') }}
>>>>>>> c01eb32006e3af5638f95e0ad8ceab816a57a70c
                        </div>
                        @endif
            ...
            <div class="row g-4">
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="blog-two__grid-item">
                        <a href="blog-details-2.html" class="blog__image d-block image">
                            <img src="{{asset('assets/front/images/blog/blog-two-grid-image1.jpg')}}" alt="image">
                            <div class="blog-tag">
                        ...
                        <div class="blog__content">
                            ...
                            <h3><a href="blog-details-2.html" class="primary-hover">Keep Your Business Safe & Ensure
                                    High
                                    Availability.</a></h3>
                            ...
                            <div class="about__info justify-content-between flex-wrap gap-3 mt-25">
                                <div class="d-flex gap-2 align-items-center">
                                    <img src="{{asset('assets/front/images/blog/admin1.png')}}" alt="image">
                                    <div class="info">
                ...
                <div class="col-lg-6">
                    <div class="blog-two__list-item mb-30 wow fadeInUp" data-wow-delay="00ms"
                        data-wow-duration="1500ms">
                        <a href="blog-details-2.html" class="blog__image d-block image">
                            <img src="{{asset('assets/front/images/blog/blog-two-list-image1.jpg')}}" alt="image">
                            <div class="blog-tag">
                        ...
                        <div class="blog__content">
                            ...
                            <h3><a href="blog-details-2.html" class="primary-hover">What’s the Holding Back the It
                                    Solution</a></h3>
                            <div class="about__info mt-30">
                                <div class="d-flex gap-2 align-items-center">
                                    <img src="{{asset('assets/front/images/blog/admin2.png')}}" alt="image">
                                    <div class="info">
                                        <a href="#0" class="primary-color">By Admin</a>
                    ...
                    <div class="blog-two__list-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <a href="blog-details-2.html" class="blog__image d-block image">
                            <img src="{{asset('assets/front/images/blog/blog-two-list-image2.jpg')}}" alt="image">
                            <div class="blog-tag">
                        ...
                        <div class="blog__content">
                            ...
                            <h3><a href="blog-details-2.html" class="primary-hover">Powerful Server and Platform</a>
                            </h3>
                            <div class="about__info mt-30">
                                <div class="d-flex gap-2 align-items-center">
                                    <img src="{{asset('assets/front/images/blog/admin3.png')}}" alt="image">
                                    <div class="info">
                                        <a href="#0" class="primary-color">By Admin</a>
                                        <h5>Prince Sakib</h5>
                                    </div>
